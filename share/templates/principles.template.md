...
## Core principles
<One numbered principle per non-negotiable rule. Each needs a rationale, so future disputes can be resolved by asking "does this still hold?" instead of re-litigating the rule itself.>

### 1. <Principle name>
**Rule:** <the non-negotiable itself, stated so a violation is unambiguous to detect.>
**Rationale:** <why this exists — a past incident, a compliance requirement, a hard-won lesson.>
...
- **Version:** 1.0.0
- **Ratified:** <date>
- **Last amended:** <date — same as ratified, until the first real amendment>
